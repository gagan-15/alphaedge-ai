            ...
            <Stack spacing={2.5} divider={<Divider flexItem />} sx={{ p: 2.5, overflowY: "auto", flex: 1 }}>
                ...
                <Section title="Market Universe" text="This decides which stocks are included in market calculations.">
                    <RadioGroup value={draft.marketUniverse} onChange={(event) => update({ ...draft, marketUniverse: event.target.value as MarketOverviewPreferences["marketUniverse"] })}>
                        {[["allnse", "NSE All Stocks", "All supported stocks listed on NSE."], ["nse500", "NSE 500", "A broad group of large and mid-size Indian companies."], ["nifty200", "Nifty 200", "The 200 larger companies in the Nifty universe."], ["nifty100", "Nifty 100", "The 100 largest companies in the Nifty universe."], ["nifty50", "Nifty 50", "The 50 largest companies in the Nifty universe."], ["fno", "F&O Stocks", "Stocks available in the futures and options market."], ["watchlist", "My Watchlist", "Only stocks saved in your watchlist."]].map(([key, title, text]) => <FormControlLabel key={key} value={key} control={<Radio size="small" />} label={<RadioLabel title={title} text={text} />} />)}
                    </RadioGroup>
                </Section>
